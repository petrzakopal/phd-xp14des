...
hold off;
ylabel('{\itM} (Nm)', 'FontName', 'Times New Roman', 'FontSize', labelsFontSize,'rotation',0, 'Color', '#000000', 'Interpreter', 'tex')
xlabel('{\itn} (min^{-1})', 'FontName', 'Times New Roman', 'FontSize', labelsFontSize, 'Interpreter', 'tex')
